  ...
  >
    ...
    <g class="ai-bot-float">
      ...
      <g class="ai-bot-eyes" filter="url(#aiBotEyeFilter)">
        <ellipse cx="50.5" cy="46.5" rx="6" ry="7.5" fill="url(#aiBotEyeGlow)" />
        <ellipse cx="69.5" cy="46.5" rx="6" ry="7.5" fill="url(#aiBotEyeGlow)" />
      </g>
      <ellipse cx="51.5" cy="44.5" rx="2.2" ry="2.8" fill="#e8feff" opacity=".95" />
      <ellipse cx="70.5" cy="44.5" rx="2.2" ry="2.8" fill="#e8feff" opacity=".95" />
