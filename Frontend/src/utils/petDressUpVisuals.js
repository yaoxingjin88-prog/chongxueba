import {
  dressupCatEarHeadband,
  dressupMagicHat,
  dressupScholarGlasses,
  dressupStarryBackpack,
} from '../config/ossAssets.js'

export const itemVisuals = {
  1: { slot: 'back', slotLabel: '背部', asset: dressupStarryBackpack },
  2: { slot: 'head', slotLabel: '头顶', asset: dressupMagicHat },
  3: { slot: 'face', slotLabel: '脸部', asset: dressupScholarGlasses },
  4: { slot: 'head', slotLabel: '头顶', asset: dressupCatEarHeadband },
}
